...
def get_api_data(request):
    ...
    if request.method == 'POST':
        ...
        if weatherapp_form.is_valid():  # You need to call the is_valid method with parentheses
    ...
    return render(request, "index.html", {'weatherdata': api_response, 'weatherForm': UserInput()})
